...
* **V-JEPA 2.1: Unlocking Dense Features in Video Self-Supervised Learning** (2026)<br>
  *arXiv preprint* <br>
  ...
  [\[Paper\]](https://arxiv.org/abs/2603.14482) [\[Code\]](https://github.com/facebookresearch/vjepa2) ⭐ 4,667 | 🐛 91 | 🌐 Python | 📅 2026-03-23
...
* **V-JEPA 2: Self-Supervised Video Models Enable Understanding, Prediction and Planning** (2025)<br>
  *arXiv preprint* <br>
  ...
  [\[Paper\]](https://arxiv.org/abs/2506.09985) [\[Code\]](https://github.com/facebookresearch/vjepa2) ⭐ 4,667 | 🐛 91 | 🌐 Python | 📅 2026-03-23
...
* **Contextualized spatio-temporal contrastive learning with self-supervision** (2022)<br>
  *CVPR 2022* <br>
  ...
  [\[Paper\]](https://openaccess.thecvf.com/content/CVPR2022/html/Yuan_Contextualized_Spatio-Temporal_Contrastive_Learning_With_Self-Supervision_CVPR_2022_paper.html) [\[Code\]](https://github.com/tensorflow/models/tree/master/official/projects/const_cl) ⭐ 77,653 | 🐛 1,271 | 🌐 Python | 📅 2026-09-16
...
* **On temporal granularity in self-supervised video representation learning** (2022)<br>
  *BMVC 2022* <br>
  ...
  [\[Paper\]](https://bmvc2022.mpi-inf.mpg.de/541/) [\[Code\]](https://github.com/tensorflow/models/tree/master/official/) ⭐ 77,653 | 🐛 1,271 | 🌐 Python | 📅 2026-09-16
...
* **InternVideo: General Video Foundation Models via Generative and Discriminative Learning** (2022)<br>
  *arXiv / Preprint* <br>
  ...
  [\[Paper\]](https://arxiv.org/abs/2212.03191) [\[Code\]](https://github.com/OpenGVLab/InternVideo) ⭐ 2,391 | 🐛 147 | 🌐 Python | 📅 2026-07-02
...
* **Spatiotemporal contrastive video representation learning** (2021)<br>
  *CVPR 2021* <br>
  ...
  [\[Paper\]](https://openaccess.thecvf.com/content/CVPR2021/html/Qian_Spatio-Temporal_Contrastive_Video_Representation_Learning_CVPR_2021_paper.html) [\[Code\]](https://github.com/tensorflow/models/tree/master/official/) ⭐ 77,653 | 🐛 1,271 | 🌐 Python | 📅 2026-09-16
...
* **VATT: Transformers for multimodal self-supervised learning from raw video, audio and text** (2021)<br>
  *NeurIPS 2021* <br>
  ...
  [\[Paper\]](https://proceedings.neurips.cc/paper/2021/hash/cb3213ada48302953cb0f166464ab356-Abstract.html) [\[Code\]](https://github.com/google-research/google-research/tree/master/vatt) ⭐ 38,807 | 🐛 1,995 | 🌐 Jupyter Notebook | 📅 2026-09-16
